...
public class AddHospitalAdminLogInDialog extends Dialog implements View.OnClickListener{
    ...
    public AddHospitalAdminLogInDialog(Context context) {
        super(context);
        mContext = context;
    }

    public AddHospitalAdminLogInDialog(Context context, int themeResId) {
        super(context, themeResId);
        mContext = context;
    }

    protected AddHospitalAdminLogInDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
...
//        Log.e("AdminLogin","hospital" + id);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.bCancel) {
            AddHospitalAdminLogInDialog.this.dismiss();
    ...
    private void login() {
        ...
        if (mEtLoginId.getText().toString().trim().toLowerCase().equals(aAdminUser.adminid.toLowerCase()) && aEncryptedPassword.equals(aAdminUser.password)) {
            ...
            AddHospitalAdminLogInDialog.this.dismiss();
            new AddHospitalDialog(getContext()).show();
        } else {
